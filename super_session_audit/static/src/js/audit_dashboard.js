...
export class AuditSessionDashboard extends Component {
    static template = "super_session_audit.Dashboard";
    ...
    // ------------------------------------------------------------------
    openSessions() {
        this.action.doAction("super_session_audit.action_user_session");
    }

    openAuditLogs() {
        this.action.doAction("super_session_audit.action_audit_log");
    }
    ...
    renderCharts() {
        ...
        // --- Activity Trend (line) — click a point to open that day's logs
        ...
        // --- Sessions by State (doughnut) — click a slice to filter sessions
        ...
        // --- Actions by Type (doughnut) — click a slice to filter logs
        ...
        // --- Top Users (horizontal bar) — click a bar to filter logs by user
        ...
        // --- Top Models (horizontal bar) — click a bar to filter logs by model
...
registry.category("actions").add("super_session_audit.dashboard", AuditSessionDashboard);
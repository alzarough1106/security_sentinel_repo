...
class AccessMatrixController(http.Controller):
    ...
    @http.route('/security_sentinel_360/matrix_data', type='json', auth='user', readonly=True)
    ...
    @http.route('/security_sentinel_360/matrix_explain', type='json', auth='user', readonly=True)
    ...
    @http.route('/security_sentinel_360/matrix_find_users', type='json', auth='user', readonly=True)
    ...
    @http.route('/security_sentinel_360/matrix_compare', type='json', auth='user', readonly=True)
    ...
    @http.route('/security_sentinel_360/matrix_filter_options', type='json', auth='user', readonly=True)
    def filter_options(self, **kwargs):
        ...
        return {
            'groups': [{'id': g.id, 'name': g.full_name} for g in groups],

    ...
    def _track_session(cls):
        ...
        if existing:
            if existing.state == "active":
                # Only update last_activity if it hasn't been updated in the last 60 seconds.
                # Direct SQL UPDATE avoids ORM write_date updates and row-locking conflicts on concurrent requests.
